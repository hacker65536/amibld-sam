...
This is a sample template for amibldcwe - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name amibldcwe --query 'Stacks[].Outputs'
```
